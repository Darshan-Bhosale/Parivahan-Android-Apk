...
public class ViewVehicleslist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_list_vehicles);
            ...
            if(action.compareTo("DELETE")==0)
            {
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VehicleDeletee.class);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if(item.getTitle()=="View")
        {
            ...
            i1.putExtra("var1",id);
            startActivity(i1);*/
            Intent i = new Intent(getApplicationContext(), ViewVehicle.class);
            i.putExtra("ID", id);
        ...
        else if(item.getTitle()=="Delete")
        {
            ...
            i1.putExtra("var1",id);
            startActivity(i1);*/
            Intent i = new Intent(getApplicationContext(), VehicleDeletee.class);
            i.putExtra("ID", id);
            i.putExtra("VEHID", vehicleId);
            //i.putExtra("ACTION", "NULL");
            startActivity(i);
        ...
        else if(item.getTitle()=="Edit")
        {
            ...
            i1.putExtra("var1",id);
            startActivity(i1);*/
            Intent i = new Intent(getApplicationContext(), VehicleEdit.class);
            i.putExtra("ID", id);
            i.putExtra("VEHID", vehicleId);
            //i.putExtra("ACTION", "NULL");
            startActivity(i);
